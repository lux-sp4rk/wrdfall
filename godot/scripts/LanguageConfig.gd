...
static func english() -> LanguageConfig:
	...
	cfg.ui_strings = {
		...
		"need_draw_more": "Need %d points to draw more!",
		"draw_more_success": "Drew %d letters! (-%d)",
...
static func spanish() -> LanguageConfig:
	...
	cfg.ui_strings = {
		...
		"need_draw_more": "\u00a1Necesitas %d puntos para sacar m\u00e1s!",
		"draw_more_success": "\u00a1%d letras sacadas! (-%d)",
